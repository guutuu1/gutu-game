...
app.get("/health", (req, res) => {
  ...
  res.json({
    success: true,
    message: "Gutu Game server is running",
    port: PORT
  });
  ...
  try {
    ...
    */
    ...
    if (!chapaResponse.ok) {
      ...
      return res.status(500).json({
        success: false,
        message: "Chapa could not initialize the payment.",
        details: chapaData
      });
